disease_dic = {
    'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        ...
        <br/>
        <br/><h4>Supplement: Lycopene</h4>
        <br/><img src="..\static\images\Suppliments\Apple_scab.jpg" alt=""height="300px" style="display: block;margin-left: auto;margin-right: auto; margin-top:50px">
        <br/>
        <br/>LINK: <a href="https://www.google.com/shopping/product/1?q=medicine+supplements+for+Apple+scab+palnt+disease&prds=epd:14909091220303875845,eto:14909091220303875845_0,pid:14909091220303875845&sa=X&ved=0ahUKEwitqoCq4JeGAxVBXmwGHa_IALwQ9pwGCAU" style="">Lycopene</a>""",
    ...
    'Apple___Black_rot': """ <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        ...
        <br/>
        <br/><h4>Supplement: Plant Enzymes</h4>
        <br/><img src="..\static\images\Suppliments\Apple_blackrot.jpg" alt=""height="300px" style="display: block;margin-left: auto;margin-right: auto; margin-top:50px">
        <br/>
        <br/>LINK: <a href="https://esupli.com/products/carlyle-plant-enzymes-with-protease-papain-lactase-and-bro" style="">Plant Enzyme</a>""",
    ...
    'Apple___Cedar_apple_rust': """ <b>Crop</b>: Apple <br/>Disease: Cedar Apple Rust<br/>
        ...
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Since the juniper galls are the source of the spores that infect the apple trees, cutting them is a sound strategy if there are not too many of them.
        ...
        <br/>
        <br/><h4>Supplement: Apple Cedar Vinegar</h4>
        <br/><img src="..\static\images\Suppliments\Apple_cedarrust.jpg" alt=""height="300px" style="display: block;margin-left: auto;margin-right: auto; margin-top:50px">
        <br/>
        <br/>LINK: <a href="https://www.apollopharmacy.in/otc/healthvit-apple-cider-vinegar-500-mg-60-capsules-for-weight-loss-detox?srsltid=AfmBOor3I7qIhc8V04CJcu2NQM8guZtobWSpOmAfRTPvv9FTvTWnDNb_aT4" style="">Apple Cider Vinegar</a>""",
    ...
    'Corn_(maize)___Common_rust_': """ <b>Crop</b>: Corn(maize) <br/>Disease: Common Rust<br/>
        ...
        <br/>
        <br/><h4>Supplement: Trichoderma</h4>
        <br/><img src="../static/images/Suppliments/Common_rust.jpg" alt=""height="300px" style="display: block;margin-left: auto;margin-right: auto; margin-top:50px">
        <br/>
        <br/>LINK: <a href="https://www.amazon.in/dp/B0BF7BQ3Q2?ref=cm_sw_r_cso_wa_apan_dp_NHW3Y45ASGKT0S1QHG2Q&ref_=cm_sw_r_cso_wa_apan_dp_NHW3Y45ASGKT0S1QHG2Q&social_share=cm_sw_r_cso_wa_apan_dp_NHW3Y45ASGKT0S1QHG2Q&starsLeft=1&skipTwisterOG=2" style="">Trichoderma</a>""",
    ...
    'Potato___Early_blight': """ <b>Crop</b>: Potato <br/>Disease: Early Blight<br/>
        ...
        <br/>
        <br/><h4>Supplement: Dimethomorph + Ametoctradin</h4>
        <br/><img src="..\static\images\Suppliments\Potato_Blight.jpg" alt=""height="300px" style="display: block;margin-left: auto;margin-right: auto; margin-top:50px">
        <br/>
        <br/>LINK: <a href="https://www.amazon.in/dp/B0BVJ3875X" style="">Dimethomorph + Ametoctradin</a>""",
